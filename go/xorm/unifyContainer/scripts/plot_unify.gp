...
plot 'data/unifyCon_noPool.csv' u 3:xtic(1) w linespoints title 'unifyCon noPool', \
...
plot 'data/unifyCon_noPool.csv' u 5:xtic(1) w linespoints title 'unifyCon noPool', \
...
plot 'data/unifyCon_noPool.csv' u 7:xtic(1) w linespoints title 'unifyCon noPool', \
