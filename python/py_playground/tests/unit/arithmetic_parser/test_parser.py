...
@pytest.mark.parametrize("tokens,expected", [
    ...
    pytest.param([Token(Type.Number, "-2"), Token(Type.Plus, "+"), Token(Type.Number, "3")], 1, id="-2+3"),
...
# fmt:off
@pytest.mark.parametrize("tokens,expected", [
    pytest.param([Token(Type.LeftParen, "("), Token(Type.Number, "2"), Token(Type.Plus, "+"), Token(Type.Number, "3"), Token(Type.RightParen, ")"), Token(Type.Mult, "*"), Token(Type.Number, "2")], 10, id="(2+3)*2"),
    pytest.param([Token(Type.LeftParen, "("), Token(Type.Number, "4"), Token(Type.Mult, "*"), Token(Type.LeftParen, "("), Token(Type.Number, "2"), Token(Type.Plus, "+"), Token(Type.Number, "3"), Token(Type.RightParen, ")"), Token(Type.RightParen, ")"), Token(Type.Mult, "*"), Token(Type.Number, "2")], 40, id="(4*(2+3))*2"),
])
# fmt:on
