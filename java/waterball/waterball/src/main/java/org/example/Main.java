...
public class Main {
    public static void main(String[] args) {
        // 註冊學生
        Student student = new Student("johnny", "password", new ArrayList<MissionCarryOn>(), new ArrayList<Adventurer>());

        // 開設旅程
//        List<Scene> scenes =Arrays.asList(new VideoScene("軟體設計模式精通之旅，一同展開冒險吧！", 1, 300),
        ...
        Journey designPattern = new Journey("軟體設計模式精通之旅", "我們只做最好的內容。", valueOf(6999),
                singletonList(new Chapter(1, "物件導向不新手的新手村",
                        singletonList(new Mission(1, "OOA｜建出你的領域模型吧！", new Challenge(1, "我做一次，你做一次！一起建出領域模型吧！"),
                                (List<Scene>)(List<?>)Arrays.asList(new VideoScene("軟體設計模式精通之旅，一同展開冒險吧！", 1, 300),
                                        new VideoScene("這個世界正是物件導向的", 2, 500),
                                        new VideoScene("物件 vs. 類別", 3, 500),
                                        new VideoScene("類別的關係 (Relationship)", 4, 600)))))),
                new ArrayList<Adventurer>(), new ArrayList<TourGroup>());
